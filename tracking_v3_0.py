...
from std_msgs.msg import Int32MultiArray, String, Bool, Float32
...
class ColorTracker:
    def __init__(self, debugging):
        ...
        self.pub_image = rospy.Publisher("~echo_image",\
                Image, queue_size=1)
	self.pub_size = rospy.Publisher('/size', Float32, queue_size=1)
	self.pug_direction = rospy.Publisher('/direction', Bool, queue_size=1)
	RGB = None
	...
	self.pub_image = rospy.Publisher("/exploration_challenge", String, queue_size=10)
...
#            yellow_upper = np.array([55, 115, 60])
...
#            blue_upper = np.array([220, 110, 110])
...
#            pink_upper = np.array([310, 50, 100])
